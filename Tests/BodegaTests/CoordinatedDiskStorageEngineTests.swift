...
final class CoordinatedDiskStorageEngineTests: XCTestCase {

    private var storage: CoordinatedDiskStorageEngine!

    override func setUp() async throws {
        storage = CoordinatedDiskStorageEngine(directory: .temporary(appendingPath: "CoordinatedTests"))
...
private extension CoordinatedDiskStorageEngineTests {
